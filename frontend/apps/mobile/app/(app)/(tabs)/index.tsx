      ...
      {filters.map((f) => {
        ...
        return (
          ...
          >
            ...
            >
              {isActive
                ? `× ${translate(`interests.${f}`, { defaultValue: f })}`
                : translate(`interests.${f}`, { defaultValue: f })}
            </Text>
          </Pressable>
        );
  ...
  return (
    ...
    >
      {event.event.presigned_url ? (
        ...
        <>
          <View
            className="absolute w-[140px] h-[140px] rounded-full opacity-95"
            style={{ backgroundColor: "#7C3AED", top: -20, left: 20 }}
          />
          <View
          ...
          />
          <View
            className="absolute w-[100px] h-[100px] rounded-full opacity-95"
            style={{ backgroundColor: "#059669", top: -5, left: 170 }}
          />
          {/* White card */}
          <View
    ...
    <FlatList
                ...
                <View className="flex-row ml-1">
                  {["#10B981", "#6366F1"].map((c, i) => (
                    <View
                      ...
                      style={{ backgroundColor: c, marginLeft: i > 0 ? -8 : 0 }}
                    />
                  ))}
                </View>
              </View>
      ...
      ListEmptyComponent={
        <View className="items-center p-8">
          <ThemedText style={{ color: AppColors.subtleText }}>
            {translate("common.noUpcomingEvents")}
          </ThemedText>
        </View>
      }
    />
