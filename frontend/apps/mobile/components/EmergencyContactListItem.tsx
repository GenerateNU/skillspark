...
export function EmergencyContactListItem({ emergencyContact, onPress }: EmergencyContactListItemProps) {
  ...
  return (
    <TouchableOpacity className="flex-row items-start py-3 gap-3" onPress={onPress} activeOpacity={0.7}>
      ...
      <View className="flex-1 gap-[2px]">
        <ThemedText className="text-base font-nunito-semibold">{emergencyContact.name}</ThemedText>
