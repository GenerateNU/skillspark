  ...
  return (
    ...
    >
      {event.event.presigned_url ? (
        ...
        <>
          <View className="absolute w-[140px] h-[140px] rounded-full opacity-95 -top-5 left-5" style={{ backgroundColor: AppColors.purple }} />
          <View className="absolute w-[120px] h-[120px] rounded-full opacity-95 top-[10px] left-[90px]" style={{ backgroundColor: AppColors.primaryBlue }} />
          <View className="absolute w-[100px] h-[100px] rounded-full opacity-95 -top-[5px] left-[170px]" style={{ backgroundColor: AppColors.green }} />
          <View
      ...
      >
        <Text style={{ fontFamily: FontFamilies.bold, fontSize: FontSizes.md, color: AppColors.primaryText }}>
