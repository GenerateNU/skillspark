...
export { AVATAR_COLORS, DARK_AVATAR_COLORS, DEFAULT_AVATAR_COLOR };
...
export function AvatarPicker({
	...
	const TAB_LABELS: Record<Tab, string> = {
		Colors: translate("childProfile.avatarTabColors"),
		Avatar: translate("childProfile.avatarTabAvatar"),
	};
