...
export default function OrgDetailsCard({
  org,
  onOrgUpdate,
  fmtDate,
  setError,
      ...
      {!editing ? (
        <>
          {orgFields.map(function (row: {
            ...
            return (
              <div
                key={row.label}
                className="px-5 py-3.5 grid grid-cols-3 gap-4"
              >
          ...
          <div className="px-5 py-3.5 grid grid-cols-3 gap-4">
            ...
            <span className="col-span-2">
              <span
                className={`inline-flex items-center text-sm font-medium px-2.5 py-1 rounded ring-1 ${org.stripe_account_activated ? "bg-green-50 text-green-700 ring-green-200" : "bg-yellow-50 text-yellow-700 ring-yellow-200"}`}
              >
        ...
        <div className="px-5 py-4 flex flex-col gap-4">
          ...
          <div className="grid grid-cols-3 gap-4 py-1">
            ...
            <span className="col-span-2 text-base text-gray-400">
