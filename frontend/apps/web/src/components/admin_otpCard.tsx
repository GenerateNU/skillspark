  ...
  return (
    <div className="mt-3 rounded-md border border-yellow-200 bg-yellow-50 p-3">
      ...
      <div className="flex items-center gap-3">
        ...
        <button onClick={copy} className="text-xs text-yellow-700 hover:text-yellow-900 font-medium border border-yellow-300 px-2 py-0.5 rounded hover:bg-yellow-100 transition-colors cursor-pointer">
          {copied ? "✓ Copied" : "Copy"}
        </button>
      </div>
