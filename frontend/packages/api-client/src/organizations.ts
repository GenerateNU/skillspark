...
} from "./generated/skillSparkAPI.schemas";
import type {
...
export type updateOrganizationResponseSuccess =
  updateOrganizationResponse200 & { headers: Headers };
export type updateOrganizationResponseError =
  updateOrganizationResponseDefault & { headers: Headers };
...
export const updateOrganization = async (
  ...
  return customInstance<updateOrganizationResponse>(
