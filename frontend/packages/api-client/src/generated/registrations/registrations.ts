...
export type cancelRegistrationResponseError =
  cancelRegistrationResponseDefault & {
    headers: Headers;
  };
...
export const cancelRegistration = async (
  ...
  return customInstance<cancelRegistrationResponse>(
    getCancelRegistrationUrl(id),
    {
      ...options,
      method: "POST",
    },
 ...
 * @summary Cancel a registration
 */
export const useCancelRegistration = <TError = ErrorModel, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof cancelRegistration>>,
      TError,
...
export type updateRegistrationPaymentStatusResponseSuccess =
  updateRegistrationPaymentStatusResponse200 & {
    headers: Headers;
  };
export type updateRegistrationPaymentStatusResponseError =
  updateRegistrationPaymentStatusResponseDefault & {
    headers: Headers;
  };

export type updateRegistrationPaymentStatusResponse =
  | updateRegistrationPaymentStatusResponseSuccess
  | updateRegistrationPaymentStatusResponseError;
...
export const updateRegistrationPaymentStatus = async (
  id: string,
  updateRegistrationPaymentStatusInputBody: NonReadonly<UpdateRegistrationPaymentStatusInputBody>,
  options?: RequestInit,
): Promise<updateRegistrationPaymentStatusResponse> => {
  return customInstance<updateRegistrationPaymentStatusResponse>(
    getUpdateRegistrationPaymentStatusUrl(id),
    {
      ...options,
      method: "PATCH",
      headers: { "Content-Type": "application/json", ...options?.headers },
      body: JSON.stringify(updateRegistrationPaymentStatusInputBody),
    },
  );
};

export const getUpdateRegistrationPaymentStatusMutationOptions = <
  TError = ErrorModel,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type UpdateRegistrationPaymentStatusMutationResult = NonNullable<
  Awaited<ReturnType<typeof updateRegistrationPaymentStatus>>
>;
export type UpdateRegistrationPaymentStatusMutationBody =
  NonReadonly<UpdateRegistrationPaymentStatusInputBody>;
export type UpdateRegistrationPaymentStatusMutationError = ErrorModel;

/**
 * @summary Update registration payment status
 */
export const useUpdateRegistrationPaymentStatus = <
  TError = ErrorModel,
  TContext = unknown,
>(
  options?: {
    mutation?: UseMutationOptions<
      ...
      {
        id: string;
        data: NonReadonly<UpdateRegistrationPaymentStatusInputBody>;
      },
      TContext
    >;
    request?: SecondParameter<typeof customInstance>;
