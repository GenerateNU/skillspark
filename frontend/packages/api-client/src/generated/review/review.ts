...
export const createReview = async (
  ...
  return customInstance<createReviewResponse>(getCreateReviewUrl(), {
    ...
    body: JSON.stringify(createReviewInputBody),
  });
};
 ...
 * @summary Creates a review
 */
export const useCreateReview = <TError = ErrorModel, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof createReview>>,
      TError,
...
export type deleteReviewResponse =
  | deleteReviewResponseSuccess
  | deleteReviewResponseError;
 ...
 * @summary Delete an existing review by id
 */
export const useDeleteReview = <TError = ErrorModel, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof deleteReview>>,
      TError,
...
export type getReviewByEventIdResponseSuccess =
  getReviewByEventIdResponse200 & {
    headers: Headers;
  };
export type getReviewByEventIdResponseError =
  getReviewByEventIdResponseDefault & {
    headers: Headers;
  };

export type getReviewByEventIdResponse =
  | getReviewByEventIdResponseSuccess
  | getReviewByEventIdResponseError;

export const getGetReviewByEventIdUrl = (
  id: string,
  ...
  return stringifiedParams.length > 0
    ? `/api/v1/review/event/${id}?${stringifiedParams}`
    : `/api/v1/review/event/${id}`;
};

export const getReviewByEventId = async (
  id: string,
  params?: GetReviewByEventIdParams,
  options?: RequestInit,
): Promise<getReviewByEventIdResponse> => {
  return customInstance<getReviewByEventIdResponse>(
    getGetReviewByEventIdUrl(id, params),
    {
      ...options,
      method: "GET",
    },
...
export const getGetReviewByEventIdQueryKey = (
  id: string,
  params?: GetReviewByEventIdParams,
) => {
  return [`/api/v1/review/event/${id}`, ...(params ? [params] : [])] as const;
};

export const getGetReviewByEventIdQueryOptions = <
  TData = Awaited<ReturnType<typeof getReviewByEventId>>,
  TError = ErrorModel,
>(
  id: string,
  params?: GetReviewByEventIdParams,
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetReviewByEventIdQueryKey(id, params);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getReviewByEventId>>
  > = ({ signal }) =>
    getReviewByEventId(id, params, { signal, ...requestOptions });
...
export type GetReviewByEventIdQueryResult = NonNullable<
  Awaited<ReturnType<typeof getReviewByEventId>>
>;
export type GetReviewByEventIdQueryError = ErrorModel;

export function useGetReviewByEventId<
  TData = Awaited<ReturnType<typeof getReviewByEventId>>,
  TError = ErrorModel,
>(
  id: string,
  params: undefined | GetReviewByEventIdParams,
  options: {
    query: Partial<
      UseQueryOptions<
        Awaited<ReturnType<typeof getReviewByEventId>>,
...
export type getReviewAggregateResponseSuccess =
  getReviewAggregateResponse200 & {
    headers: Headers;
  };
export type getReviewAggregateResponseError =
  getReviewAggregateResponseDefault & {
    headers: Headers;
  };

export type getReviewAggregateResponse =
  | getReviewAggregateResponseSuccess
  | getReviewAggregateResponseError;
...
export const getReviewAggregate = async (
  id: string,
  options?: RequestInit,
): Promise<getReviewAggregateResponse> => {
  return customInstance<getReviewAggregateResponse>(
    getGetReviewAggregateUrl(id),
    {
      ...options,
      method: "GET",
    },
...
export const getGetReviewAggregateQueryKey = (id: string) => {
  return [`/api/v1/review/event_aggregate/${id}`] as const;
};
...
>(
  ...
  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getReviewAggregate>>
  > = ({ signal }) => getReviewAggregate(id, { signal, ...requestOptions });
