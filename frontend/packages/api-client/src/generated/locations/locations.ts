...
export type getAllLocationsResponse =
  | getAllLocationsResponseSuccess
  | getAllLocationsResponseError;
...
export const getAllLocations = async (
  ...
  return customInstance<getAllLocationsResponse>(
    getGetAllLocationsUrl(params),
    {
      ...options,
      method: "GET",
    },
...
>(
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getAllLocations>>> = ({
    signal,
  }) => getAllLocations(params, { signal, ...requestOptions });
...
export function useGetAllLocations<
  ...
  TError = ErrorModel,
>(
  params: undefined | GetAllLocationsParams,
  options: {
    query: Partial<
      UseQueryOptions<
        Awaited<ReturnType<typeof getAllLocations>>,
...
export type postLocationResponse =
  | postLocationResponseSuccess
  | postLocationResponseError;
...
export const postLocation = async (
  ...
  return customInstance<postLocationResponse>(getPostLocationUrl(), {
    ...
    body: JSON.stringify(createLocationInputBody),
  });
};
...
export type getLocationByIdResponse =
  | getLocationByIdResponseSuccess
  | getLocationByIdResponseError;
...
>(
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getLocationById>>> = ({
    signal,
  }) => getLocationById(id, { signal, ...requestOptions });
