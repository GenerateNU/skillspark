...
func (h *Handler) GetEventReviewsForOrganization(ctx context.Context, id uuid.UUID, pagination utils.Pagination, sortBy string) ([]models.SimpleReviewAggregate, error) {
