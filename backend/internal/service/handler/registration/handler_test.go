...
func TestHandler_GetRegistrationByID_AcceptLanguageInvariant(t *testing.T) {
	...
	for _, tt := range invalidLanguages {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			result, err := handler.GetRegistrationByID(context.Background(), input)
...
func TestHandler_GetRegistrationsByChildID_AcceptLanguageInvariant(t *testing.T) {
	invalidLanguages := []struct {
		name string
		lang string
	}{
	...
	for _, tt := range invalidLanguages {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			result, err := handler.GetRegistrationsByChildID(context.Background(), input)
			assert.Nil(t, result, "expected nil result for invalid AcceptLanguage")
			assert.NotNil(t, err, "expected error for invalid AcceptLanguage")
			assert.Contains(t, err.Error(), "Invalid AcceptLanguage")
		})
...
func TestHandler_GetRegistrationsByGuardianID_AcceptLanguageInvariant(t *testing.T) {
	invalidLanguages := []struct {
		name string
		lang string
	}{
	...
	for _, tt := range invalidLanguages {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			result, err := handler.GetRegistrationsByGuardianID(context.Background(), input)
			assert.Nil(t, result, "expected nil result for invalid AcceptLanguage")
			assert.NotNil(t, err, "expected error for invalid AcceptLanguage")
			assert.Contains(t, err.Error(), "Invalid AcceptLanguage")
		})
...
func TestHandler_GetRegistrationsByEventOccurrenceID_AcceptLanguageInvariant(t *testing.T) {
	invalidLanguages := []struct {
		name string
		lang string
	}{
	...
	for _, tt := range invalidLanguages {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			result, err := handler.GetRegistrationsByEventOccurrenceID(context.Background(), input)
			assert.Nil(t, result, "expected nil result for invalid AcceptLanguage")
			assert.NotNil(t, err, "expected error for invalid AcceptLanguage")
			assert.Contains(t, err.Error(), "Invalid AcceptLanguage")
		})
...
func TestHandler_GetRegistrationByPaymentIntentID_AcceptLanguageInvariant(t *testing.T) {
	invalidLanguages := []struct {
		name string
		lang string
	}{
	...
	for _, tt := range invalidLanguages {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			input := &models.GetRegistrationByPaymentIntentIDInput{
				AcceptLanguage:  tt.lang,
				PaymentIntentID: "pi_test_123",
			}
			...
			result, err := handler.GetRegistrationByPaymentIntentID(context.Background(), input)
			assert.Nil(t, result, "expected nil result for invalid AcceptLanguage")
			assert.NotNil(t, err, "expected error for invalid AcceptLanguage")
			assert.Contains(t, err.Error(), "Invalid AcceptLanguage")
		})
...
func TestHandler_CreateRegistration_AcceptLanguageInvariant(t *testing.T) {
	invalidLanguages := []struct {
		name string
		lang string
	}{
	...
	for _, tt := range invalidLanguages {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			input.Body.ChildID = uuid.New()
			input.Body.GuardianID = uuid.New()
			input.Body.EventOccurrenceID = uuid.New()
			...
			result, err := handler.CreateRegistration(context.Background(), input)
			assert.Nil(t, result, "expected nil result for invalid AcceptLanguage")
			assert.NotNil(t, err, "expected error for invalid AcceptLanguage")
			assert.Contains(t, err.Error(), "Invalid AcceptLanguage")
		})
...
func TestHandler_UpdateRegistration_AcceptLanguageInvariant(t *testing.T) {
	invalidLanguages := []struct {
		name string
		lang string
	}{
	...
	for _, tt := range invalidLanguages {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			result, err := handler.UpdateRegistration(context.Background(), input)
			assert.Nil(t, result, "expected nil result for invalid AcceptLanguage")
			assert.NotNil(t, err, "expected error for invalid AcceptLanguage")
			assert.Contains(t, err.Error(), "Invalid AcceptLanguage")
		})
...
func TestHandler_CancelRegistration_AcceptLanguageInvariant(t *testing.T) {
	invalidLanguages := []struct {
		name string
		lang string
	}{
	...
	for _, tt := range invalidLanguages {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			result, err := handler.CancelRegistration(context.Background(), input)
			assert.Nil(t, result, "expected nil result for invalid AcceptLanguage")
			assert.NotNil(t, err, "expected error for invalid AcceptLanguage")
			assert.Contains(t, err.Error(), "Invalid AcceptLanguage")
		})
...
func TestHandler_UpdateRegistrationPaymentStatus_AcceptLanguageInvariant(t *testing.T) {
	invalidLanguages := []struct {
		name string
		lang string
	}{
	...
	for _, tt := range invalidLanguages {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			result, err := handler.UpdateRegistrationPaymentStatus(context.Background(), input)
			assert.Nil(t, result, "expected nil result for invalid AcceptLanguage")
			assert.NotNil(t, err, "expected error for invalid AcceptLanguage")
			assert.Contains(t, err.Error(), "Invalid AcceptLanguage")
		})
