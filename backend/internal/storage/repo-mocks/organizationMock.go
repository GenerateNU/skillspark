...
func (m *MockOrganizationRepository) CreateOrganization(ctx context.Context, input *models.CreateOrganizationInput, PfpS3Key *string) (*models.Organization, *errs.HTTPError) {
...
func (m *MockOrganizationRepository) UpdateOrganization(ctx context.Context, input *models.UpdateOrganizationInput, PfpS3Key *string) (*models.Organization, *errs.HTTPError) {
	args := m.Called(ctx, input, PfpS3Key)
	if args.Get(0) == nil {
		if args.Get(1) == nil {
			return nil, nil
