...
new_guardian AS (
    ...
    RETURNING id, user_id, expo_push_token, created_at, updated_at
)
SELECT g.id, g.user_id, u.name, u.email, u.username, u.profile_picture_s3_key, u.language_preference, u.auth_id, g.expo_push_token, g.created_at, g.updated_at
FROM new_guardian g
