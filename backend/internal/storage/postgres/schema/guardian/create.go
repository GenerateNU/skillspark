...
func (r *GuardianRepository) CreateGuardian(ctx context.Context, guardian *models.CreateGuardianInput) (*models.Guardian, error) {
	...
	err = row.Scan(&createdGuardian.ID, &createdGuardian.UserID, &createdGuardian.Name, &createdGuardian.Email, &createdGuardian.Username, &createdGuardian.ProfilePictureS3Key, &createdGuardian.LanguagePreference, &createdGuardian.AuthID, &createdGuardian.CreatedAt, &createdGuardian.UpdatedAt)
	if err != nil {
