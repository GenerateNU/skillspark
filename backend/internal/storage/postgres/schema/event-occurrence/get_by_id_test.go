...
func TestEventOccurrenceRepository_GetEventOccurrenceById(t *testing.T){
	...
	assert.Equal(t, uuid.MustParse("50000000-0000-0000-0000-000000000001"), eventOccurrence1.ManagerId)
	...
	assert.Equal(t, uuid.MustParse("50000000-0000-0000-0000-000000000001"), eventOccurrence2.ManagerId)
	...
	assert.Nil(t, err)
	assert.NotNil(t, eventOccurrence1)
	assert.Equal(t, uuid.MustParse("50000000-0000-0000-0000-000000000001"), eventOccurrence3.ManagerId)
