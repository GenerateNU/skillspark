...
func TestEventOccurrenceRepository_GetAllEventOccurrences(t *testing.T) {
	...
	eventOccurrences, err := repo.GetAllEventOccurrences(ctx, pagination, "en-US")
	assert.Nil(t, err)
...
func TestEventOccurrenceRepository_GetAllEventOccurrences_Pagination(t *testing.T) {
	...
	eventOccurrences1, err1 := repo.GetAllEventOccurrences(ctx, pagination1, "en-US")
	assert.Nil(t, err1)
	...
	eventOccurrences2, err2 := repo.GetAllEventOccurrences(ctx, pagination2, "en-US")
	assert.Nil(t, err2)
	...
	eventOccurrences3, err3 := repo.GetAllEventOccurrences(ctx, pagination3, "en-US")
	assert.Nil(t, err3)
